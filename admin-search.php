<?php
    ...
    require_once "layouts/search/admin_Search.php";
    ...
    $search = new layouts\search\admin_Search();
    $showingNumber = 4;
        ...
        <div id="global-container">
            ...
            <div id="master-middle">
                ...
                <div class="no-search-container flex-row-column">
                    <p class="no-search-results">Arama sonucu bulamadık.</p>
                </div>

                <div class="flex-row-column empty-search">
                    <p style="margin: 0">Yukarıdaki kutuya aramak istediğiniz şeyi yazınız.</p>
                </div>
